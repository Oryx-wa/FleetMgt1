...
Public Class Mtce_Schedule_Report
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Mtce Schedule Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FleetMgt.Mtce Schedule Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMtce_Schedule_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Mtce_Schedule_Report = New Mtce_Schedule_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
