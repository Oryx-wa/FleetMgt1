...
Public Class Equipment_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FleetMgt.Equipment List.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pLocaSelect_Codename_Location_from_OWA_FMLOCATION() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedEquipment_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Equipment_List = New Equipment_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
