...
Public Class Work_Order_Form
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AddOnInstaller.Work Order Form.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWork_Order_Form
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Work_Order_Form = New Work_Order_Form()
        rpt.Site = Me.Site
        Return rpt
    End Function
