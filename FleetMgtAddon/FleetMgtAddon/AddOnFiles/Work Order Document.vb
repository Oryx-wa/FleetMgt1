...
Public Class Work_Order_Document
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Work Order Document.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AddOnInstaller.Work Order Document.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWork_Order_Document
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Work_Order_Document = New Work_Order_Document()
        rpt.Site = Me.Site
        Return rpt
    End Function
