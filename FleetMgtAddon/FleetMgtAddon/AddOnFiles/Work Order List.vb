...
Public Class Work_Order_List
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AddOnInstaller.Work Order List.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pComplDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWork_Order_List
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Work_Order_List = New Work_Order_List()
        rpt.Site = Me.Site
        Return rpt
    End Function
